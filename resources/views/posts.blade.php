        ...
        <form class="max-w-md mx-auto">
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search"
                    ...
                    placeholder="Search Mockups, Logos..." required name="search" autocomplete="off" />
                <button type="submit"
        ...
        <div class="mt-4 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article
                ...
                <div class="flex justify-between items-center mb-5 text-gray-500">
                    <a href="/posts?category={{ $post->category->slug }}" class="hover:underline text-gray-900">
                ...
                <p class="mb-5 font-light text-gray-500 dark:text-gray-400 line-clamp-3">{!! $post->body !!}</p>
                <div class="flex justify-between items-center">
                    <a href="/posts?author={{ $post->author->username }}">
                        <div class="flex items-center space-x-4">
                            <img class="w-7 h-7 rounded-full"
                                src="{{ $post->author->avatar ? asset($post->author->avatar) : asset('img/avt.jpg') }}"
            ...
            <div class="">
                ...
                <a href="/posts" class="block hover:text-blue-500 hover:underline">&laquo; Back to all posts.</a>
            </div>
            @endforelse
